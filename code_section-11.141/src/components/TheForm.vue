<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="interest-news" name="interests" type="checkbox" value="news" v-model="interests"/>
        <label for="interest-news">News</label>
      </div>
      <div>
        <input id="interest-tutorials" name="interests" type="checkbox" value="tutorials" v-model="interests"/>
        <label for="interest-tutorials">Tutorials</label>
      </div>
      <div>
        <input id="interest-nothing" name="interests" type="checkbox" value="nothing" v-model="interests"/>
